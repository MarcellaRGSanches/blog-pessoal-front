...
function Cadastro() {
    ...
    //Hook Navigate para redirecionar rotas 
    const navigate = useNavigate();

    //Estado que vai guardar os dados do usuario
    ...
    //Estado que vai guaradar a confirmação de senha  
    ...
    //Redirecionar para o Componente Login(rota/login)
    function retornar(){
        navigate('/login')
    }
    ...
    async function cadastrarNovoUsuario(e: FormEvent<HTMLFormElement>) {
        ...
        if (confirmaSenha === usuario.senha && usuario.senha.length >= 8) {
            ...
            try {
                ...
                ToastAlerta('Erro ao cadastrar o novo usuário!','erro')
            }
    ...
    // function retornar(event: MouseEvent<HTMLButtonElement, MouseEvent>): void {
